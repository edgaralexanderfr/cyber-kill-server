...
func TestVector2GetDirectionTo1(t *testing.T) {
	...
	result := origin1.GetDirectionTo(target1, speed1)
...
func TestVector2GetDirectionTo2(t *testing.T) {
	...
	result := origin2.GetDirectionTo(target2, speed2)
...
func TestVector2GetDirectionTo3(t *testing.T) {
	...
	result := origin3.GetDirectionTo(target3, speed3)
...
func TestVector2GetDirectionTo4(t *testing.T) {
	...
	result := origin4.GetDirectionTo(target4, speed4)
...
func TestVector2GetDirectionTo5(t *testing.T) {
	...
	result := origin5.GetDirectionTo(target5, speed5)
...
func TestVector2GetDirectionTo6(t *testing.T) {
	...
	result := origin6.GetDirectionTo(target6, speed6)
...
func TestVector2GetDirectionTo7(t *testing.T) {
	...
	result := origin7.GetDirectionTo(target7, speed7)
